...
public class AspectGenerator {
	...
	public static void generateBGM(final String propertiesFile, final String interfaceImpl) {
		try {
	        ...
	        DataInputStream input = new DataInputStream(AspectConstructor.class.getResourceAsStream("/resources/codeBlocks/org.aspectj.runtime_1.9.2.201811011643.jar"));
	        new File("src-gen/aspects/dependencies").mkdirs();
	        FileOutputStream fos = new FileOutputStream("src-gen/aspects/dependencies/org.aspectj.runtime_1.9.2.201811011643.jar");
...
//			String f = AspectGenerator.class.getResource("/resources/codeBlocks/org.aspectj.runtime_1.9.2.201811011643.jar").getFile();

//			File _file_7 = new File(f);
...
//			FileUtils.copyFile(_file_7, _file_8);
		...
		while (iter.hasNext()) {
			{
				...
				if ((obj instanceof org.eclipse.uml2.uml.Class)) {
					int _compareTo = ((org.eclipse.uml2.uml.Class) obj).getClass().getCanonicalName()
							.compareTo("org.eclipse.uml2.uml.internal.impl.ClassImpl");
							...
							for (final Operation operation : _operations) {
								{
									...
									boolean _equals_1 = IterableExtensions
											.<Operation>last(((org.eclipse.uml2.uml.Class) obj).getOperations())
											.equals(operation);
	...
	public static StringBuffer aroundBlock(final EObject root) {
		StringBuffer result = new StringBuffer();
		result.append(
				"Object around(Identified targetIdentified): target(targetIdentified) &&  !execution(* *.getUUID()) && !execution(* *.setUUID()) && (");
