 ...
 * </p>
 * <ul>
 *   <li>{@link xtendCode.prov.Generation#getEntity <em>Entity</em>}</li>
 *   <li>{@link xtendCode.prov.Generation#getActivity <em>Activity</em>}</li>
 *   <li>{@link xtendCode.prov.Generation#getTime <em>Time</em>}</li>
 *   <li>{@link xtendCode.prov.Generation#getLabel <em>Label</em>}</li>
 *   <li>{@link xtendCode.prov.Generation#getLocation <em>Location</em>}</li>
 *   <li>{@link xtendCode.prov.Generation#getRole <em>Role</em>}</li>
 *   <li>{@link xtendCode.prov.Generation#getType <em>Type</em>}</li>
 *   <li>{@link xtendCode.prov.Generation#getAny <em>Any</em>}</li>
 *   <li>{@link xtendCode.prov.Generation#getId <em>Id</em>}</li>
 *   <li>{@link xtendCode.prov.Generation#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @see xtendCode.prov.ProvPackage#getGeneration()
 * @model extendedMetaData="name='Generation' kind='elementOnly'"
 * @generated
 */
public interface Generation extends EObject {
	 ...
	 * @see #setEntity(IDRef)
	 * @see xtendCode.prov.ProvPackage#getGeneration_Entity()
	...
	/**
	 * Sets the value of the '{@link xtendCode.prov.Generation#getEntity <em>Entity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see xtendCode.prov.ProvPackage#getGeneration_Activity()
	...
	/**
	 * Sets the value of the '{@link xtendCode.prov.Generation#getActivity <em>Activity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see xtendCode.prov.ProvPackage#getGeneration_Time()
	...
	/**
	 * Sets the value of the '{@link xtendCode.prov.Generation#getTime <em>Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see xtendCode.prov.ProvPackage#getGeneration_Label()
	 * @model containment="true"
	 ...
	 * @see xtendCode.prov.ProvPackage#getGeneration_Location()
	 ...
	 * @see xtendCode.prov.ProvPackage#getGeneration_Role()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType"
	 ...
	 * @see xtendCode.prov.ProvPackage#getGeneration_Type()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType"
	 ...
	 * @see xtendCode.prov.ProvPackage#getGeneration_Any()
	 ...
	 * @see #setId(QName)
	 * @see xtendCode.prov.ProvPackage#getGeneration_Id()
	...
	/**
	 * Sets the value of the '{@link xtendCode.prov.Generation#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see xtendCode.prov.ProvPackage#getGeneration_AnyAttribute()
