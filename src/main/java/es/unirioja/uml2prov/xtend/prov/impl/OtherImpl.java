 ...
 * </p>
 * <ul>
 *   <li>{@link xtendCode.prov.impl.OtherImpl#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OtherImpl extends MinimalEObjectImpl.Container implements Other {
	...
	protected EClass eStaticClass() {
		return ProvPackage.Literals.OTHER;
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, ProvPackage.OTHER__ANY);
		}
		return any;
	}
