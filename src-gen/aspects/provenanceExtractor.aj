...
import aspects.listeners.ListenerCSV;
...
pointcut captureOperationsStack(): 	call(* Stack.Stack.getSize(..)) || 	call(* Stack.Stack.push(..)) || 	call(* Stack.Stack.pop(..)) || 	call(* Stack.Stack.isEmpty(..)) || 	call(* Stack.Stack.setTop(..)) || 	call(* Stack.Stack.Stack(..));
...
pointcut captureOperationsPerson(): 	call(* Stack.Person.getName(..)) || 	call(* Stack.Person.Person(..));
 ;
