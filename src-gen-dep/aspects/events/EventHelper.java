...
/*
 * Author: Francisco Garcia Izquierdo
...
/**
 * Helper para el registro de listeners de tipo Listener genérico y para la
 * notificación de los eventos a los listeners registrados.
 * <p>
 * Las clases que sean fuente de eventos de ejecución podrán usar objetos de
 * esta clase para realizar las tareas relacionadas con la gestión de los 
 * listener y la notificación de los eventos.
 */
public class EventHelper<L> {
	...
	/**
	 * Elimina la suscripción de un listener
	 */
	 ...
	 */
	public void fireEvent(String name, EventObject evt)
		...
		if (m == null) {
			throw new NoSuchElementException(
					"Los listeners gestionados por este helper no disponen del metodo "
							+ name);
		}
		...
		for (L listener : listeners) {
			try {
				...
				System.err.println("IllegalAccessException reaching listener: "
						+ listener);
